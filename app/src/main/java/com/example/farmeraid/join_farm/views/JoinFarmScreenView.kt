package com.example.farmeraid.join_farm.views
...
import com.example.farmeraid.join_farm.JoinFarmViewModel
...
@Composable
fun JoinFarmScreenView() {
    val viewModel = hiltViewModel<JoinFarmViewModel>()
    ...
    Scaffold {
        Column (
            ...
            Column(
                ...
                Text(text = "Join a Farm", style = TextStyle(fontSize = 30.sp))

                Spacer(modifier = Modifier.height(50.dp))

                TextField(
                    label = { Text(text = "Farm Code") },
                    value = state.farmCode,
                    onValueChange = { viewModel.setFarmCode(it) },
                ...
                Row(
                    ...
                    ButtonView(
                        ...
                        buttonUiEvent = UiComponentModel.ButtonUiEvent(
                            onClick = { viewModel.submitFarmCode() }
                        ),
                        modifier = Modifier
                            .height(50.dp)
                            .width(120.dp)
